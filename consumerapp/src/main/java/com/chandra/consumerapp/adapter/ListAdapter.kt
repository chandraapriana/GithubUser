package com.chandra.consumerapp.adapter
...
import com.chandra.consumerapp.databinding.ItemRowBinding
import com.chandra.github.data.model.UserResponse

class ListAdapter(private val listUsers: List<UserResponse>) :
